# Christian Bucher - Original Evidence Excerpts

This repository contains a curated source-evidence package: selected original excerpts from the systems, notebooks, architecture notes, research blueprints and formal project material behind Christian Bucher's portfolio. The goal is to let a technical reviewer inspect real artifacts directly.
